...
import { AccountOverviewTabsOptions, AccountOverviewTabs } from './account-overview-tabs';

export type AccountOverviewLayoutOptions = AccountOverviewTabsOptions & {
  children: React.ReactElement;
};

export const AccountOverviewLayout = (options: AccountOverviewLayoutOptions) => {
